...
public class OpSword extends SwordItem{
    ...
    public boolean hitEntity(ItemStack stack, LivingEntity target, LivingEntity attacker) {
	    if (target instanceof EnderDragonEntity){
            ...
            drageon.func_213403_a(drageon.dragonPartHead, DamageSource.causePlayerDamage((PlayerEntity) attacker), 10000);
            ...
            else
            {
                if (entity instanceof IMob)
                {
                    if (entity instanceof EnderDragonEntity){
                        ...
                        drageon.func_213403_a(drageon.dragonPartHead, DamageSource.causePlayerDamage(player), 10000);
