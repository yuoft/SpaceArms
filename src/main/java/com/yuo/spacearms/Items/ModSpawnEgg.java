...
import com.yuo.spacearms.Arms.SpaceArms;
...
public class ModSpawnEgg extends SpawnEggItem {
    public static final List<ModSpawnEgg> UNADDED_EGGS = new ArrayList<>();
    ...
    public ModSpawnEgg(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, int primaryColorIn, int secondaryColorIn) {
        super(null, primaryColorIn, secondaryColorIn, new Properties().group(SATabs.spaceArms));
