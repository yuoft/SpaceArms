...
public class SAItems {
	...
	public static RegistryObject<Item> spacePath = ITEMS.register("space_path", SpacePath::new);
	public static RegistryObject<Item> spaceIngot = ITEMS.register("space_ingot", FireImmuneItem::new);
	public static RegistryObject<Item> jade = ITEMS.register("jade", OrdinaryItem::new);
	public static RegistryObject<Item> spaceCore = ITEMS.register("space_core", FireImmuneItem::new);
	...
	public static RegistryObject<Item> bedrockPowder = ITEMS.register("bedrock_powder", FireImmuneItem::new);
	public static RegistryObject<Item> bedrockIngot = ITEMS.register("bedrock_ingot", FireImmuneItem::new);
	public static RegistryObject<Item> bedrockNugget = ITEMS.register("bedrock_nugget", FireImmuneItem::new);
	public static RegistryObject<Item> spaceString = ITEMS.register("space_string", FireImmuneItem::new);
	...
	public static RegistryObject<Item> netheriteStick = ITEMS.register("netherite_stick", FireImmuneItem::new);
