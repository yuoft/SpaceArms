...
public class VillagerEvents {
    ...
    public static void registerTrades(VillagerTradesEvent event) {
        ...
        if (VillagerProfession.WEAPONSMITH.equals(type)){
            ...
            trades.get(1).add(new EmeraldForItemsTrade(ItemRegistry.rubyIngot.get(), 10, 16, 2));
            trades.get(2).add(new EmeraldForItemsTrade(ItemRegistry.emeraldIngot.get(), 8, 12, 3));
            trades.get(3).add(new EmeraldForItemsTrade(ItemRegistry.netheriteIngot.get(), 6, 10, 4));
            trades.get(4).add(new EmeraldForItemsTrade(ItemRegistry.dragonCrystal.get(), 4, 8, 5));
