...
public enum MyArmorMaterial implements IArmorMaterial {
	...
	RUBY(Spacearms.MODID + ":" + "ruby", 23, new int[] { 3, 6, 8, 3 }, 12, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0.5F, 0,() -> {
		return Ingredient.fromItems(ItemRegistry.rubyIngot.get());
	}),
	TOTEM(Spacearms.MODID + ":" + "totem", 20, new int[] { 3, 6, 8, 3 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.0F, 0,() -> {
		return Ingredient.fromItems(Items.TOTEM_OF_UNDYING);
	}),
	GLOWSTONE(Spacearms.MODID + ":" + "glowstone", 13, new int[] { 2, 5, 6, 2 }, 8, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0.5F,0, () -> {
		return Ingredient.fromItems(Items.GLOWSTONE);
	}),
	EMERALD(Spacearms.MODID + ":" + "emerald", 25, new int[] { 4, 7, 9, 4 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0.5F, 0,() -> {
		return Ingredient.fromItems(ItemRegistry.emeraldIngot.get());
	}),
	SPACE(Spacearms.MODID + ":" + "space", 49, new int[] { 10, 13, 15, 10 }, 15, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 5.0F, 0.2f,() -> {
		return Ingredient.fromItems(ItemRegistry.spaceIngot.get());
	}),
	DRAGON(Spacearms.MODID + ":" + "dragon", 41, new int[] { 7, 10, 12, 7 }, 13, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3.5F, 0.15f,() -> {
