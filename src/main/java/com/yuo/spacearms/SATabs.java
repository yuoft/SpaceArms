...
//创造模式物品栏 实例化
public class SATabs {
	public static final DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, SpaceArms.MOD_ID);
	public static final RegistryObject<CreativeModeTab> SA_TAB0 = TABS.register(SpaceArms.MOD_ID + "_tab0", () -> CreativeModeTab.builder()
	...
	public static final RegistryObject<CreativeModeTab> SA_TAB1 = TABS.register(SpaceArms.MOD_ID + "_tab1", () -> CreativeModeTab.builder()
